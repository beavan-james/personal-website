export const site = {
  ...
  location: "Atlanta, GA",
  blurb:
    "Junior at Georgia Tech studying Mathematics. I enjoy solving problems and am interested in data science & engineering.",
...
export const experienceItems = [
  {
    ...
    detail:
      "Worked on the manufacturing analytics team under the CIDO sector",
    bullets: [
  ...
  },
  {
    ...
    place: "Columbia, MD",
    detail:
      "Primarily focused on data ingestion and analytics work",
    bullets: [
  ...
  },
  {
    ...
    place: "Falls Church, VA",
    detail:
      "Focused on assisting with development of a gene-sequence retrieval tool",
    bullets: [
