export const site = {
  ...
  experienceIntro:
    "Internships and school so far, including manufacturing analytics, nonprofit data platforms, and applied ML tooling.",
};
...
export const projects = [
  ...
  },
  {
    ...
    category: "Backend",
    description:
      "Built and documented 30+ REST APIs for users, schools, vendors, deliveries, and orders, including filtering, pagination, sorting, plus role-based access for admins, accounting, vendors, schools, and operations.",
